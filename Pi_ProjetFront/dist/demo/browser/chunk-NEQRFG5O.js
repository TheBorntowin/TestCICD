...
function CircleProgressComponent__svg_svg_0__svg_ng_container_4__svg_circle_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275attribute("fill", \u0275\u0275interpolate2("url(", ctx_r1.window.location.href, "#", ctx_r1.svg.radialGradient.id, ")"))("cx", ctx_r1.svg.backgroundCircle.cx)("cy", ctx_r1.svg.backgroundCircle.cy)("r", ctx_r1.svg.backgroundCircle.r)("fill-opacity", ctx_r1.svg.backgroundCircle.fillOpacity)("stroke", ctx_r1.svg.backgroundCircle.stroke)("stroke-width", ctx_r1.svg.backgroundCircle.strokeWidth);
  }
}
...
function CircleProgressComponent__svg_svg_0__svg_ng_container_6__svg_path_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275attribute("stroke", \u0275\u0275interpolate2("url(", ctx_r1.window.location.href, "#", ctx_r1.svg.outerLinearGradient.id, ")"))("d", ctx_r1.svg.path.d)("stroke-width", ctx_r1.svg.path.strokeWidth)("stroke-linecap", ctx_r1.svg.path.strokeLinecap)("fill", ctx_r1.svg.path.fill);
  }
}
...
// src/app/components/charts/circle-progress-blue.component.ts
var CircleProgressBlueComponent = class _CircleProgressBlueComponent {
  constructor(cdr) {
    this.cdr = cdr;
  }
  ngAfterViewInit() {
  ...
  static {
    this.\u0275fac = function CircleProgressBlueComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _CircleProgressBlueComponent)(\u0275\u0275directiveInject(ChangeDetectorRef));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CircleProgressBlueComponent, selectors: [["app-circle-progress-blue"]], features: [\u0275\u0275ProvidersFeature([
      {
        provide: CircleProgressOptions
      }
    ])], decls: 1, vars: 14, consts: [[1, "avatar", "avatar-80", 3, "percent", "space", "radius", "outerStrokeWidth", "innerStrokeWidth", "outerStrokeColor", "innerStrokeColor", "animation", "showSubtitle", "titleFontSize", "unitsFontSize", "titleColor", "unitsColor", "animationDuration"]], template: function CircleProgressBlueComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "circle-progress", 0);
      }
      if (rf & 2) {
        \u0275\u0275property("percent", 65)("space", -6)("radius", 40)("outerStrokeWidth", 6)("innerStrokeWidth", 6)("outerStrokeColor", "#0088FF")("innerStrokeColor", "rgba(0, 73, 232, 0.15)")("animation", true)("showSubtitle", false)("titleFontSize", "26px")("unitsFontSize", "20px")("titleColor", "#0088FF")("unitsColor", "#0088FF")("animationDuration", 300);
      }
    }, dependencies: [NgCircleProgressModule, CircleProgressComponent], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CircleProgressBlueComponent, [{
    type: Component,
    args: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CircleProgressBlueComponent, { className: "CircleProgressBlueComponent", filePath: "src/app/components/charts/circle-progress-blue.component.ts", lineNumber: 16 });
})();
...
//# sourceMappingURL=chunk-NEQRFG5O.js.map
