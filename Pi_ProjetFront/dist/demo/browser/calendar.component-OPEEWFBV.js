...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js"(exports, module) {
    ...
    !(function(t3, e3) {
      ...
      "use strict";
      var t3 = 1e3, e3 = 6e4, n2 = 36e5, r3 = "millisecond", i3 = "second", s3 = "minute", u3 = "hour", a3 = "day", o2 = "week", c3 = "month", f3 = "quarter", h3 = "year", d2 = "date", l3 = "Invalid Date", $3 = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y3 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M2 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t4) {
        ...
        return { M: c3, y: h3, w: o2, d: a3, D: d2, h: u3, m: s3, s: i3, ms: r3, Q: f3 }[t4] || String(t4 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t4) {
        return void 0 === t4;
      } }, g4 = "en", D3 = {};
      D3[g4] = M2;
      ...
      b3.l = w4, b3.i = S2, b3.w = function(t4, e4) {
        return O2(t4, { locale: e4.$L, utc: e4.$u, x: e4.$x, $offset: e4.$offset });
      };
      var _3 = (function() {
        function M3(t4) {
          this.$L = w4(t4.locale, null, true), this.parse(t4), this.$x = this.$x || t4.x || {}, this[p3] = true;
        }
        var m4 = M3.prototype;
        return m4.parse = function(t4) {
          ...
          var n3, o3 = b3.p(t4), f4 = "set" + (this.$u ? "UTC" : ""), l4 = (n3 = {}, n3[a3] = f4 + "Date", n3[d2] = f4 + "Date", n3[c3] = f4 + "Month", n3[h3] = f4 + "FullYear", n3[u3] = f4 + "Hours", n3[s3] = f4 + "Minutes", n3[i3] = f4 + "Seconds", n3[r3] = f4 + "Milliseconds", n3)[o3], $4 = o3 === a3 ? this.$D + (e4 - this.$W) : e4;
          if (o3 === c3 || o3 === h3) {
            var y4 = this.clone().set(d2, 1);
            y4.$d[l4]($4), y4.init(), this.$d = y4.set(d2, Math.min(this.$D, y4.daysInMonth())).$d;
          } else l4 && this.$d[l4]($4);
          ...
          if ($4 === a3) return y4(1);
          if ($4 === o2) return y4(7);
          var M4 = (d3 = {}, d3[s3] = e3, d3[u3] = n2, d3[i3] = t3, d3)[$4] || 1, m5 = this.$d.getTime() + r4 * M4;
          return b3.w(m5, this);
          ...
          var r4 = t4 || "YYYY-MM-DDTHH:mm:ssZ", i4 = b3.z(this), s4 = this.$H, u4 = this.$m, a4 = this.$M, o3 = n3.weekdays, c4 = n3.months, f4 = n3.meridiem, h4 = function(t5, n4, i5, s5) {
            return t5 && (t5[n4] || t5(e4, r4)) || i5[n4].slice(0, s5);
          }, d3 = function(t5) {
            return b3.s(s4 % 12 || 12, t5, "0");
          }, $4 = f4 || function(t5, e5, n4) {
            var r5 = t5 < 12 ? "AM" : "PM";
        ...
        }, m4.diff = function(r4, d3, l4) {
          var $4, y4 = this, M4 = b3.p(d3), m5 = O2(r4), v4 = (m5.utcOffset() - this.utcOffset()) * e3, g5 = this - m5, D4 = function() {
            return b3.m(y4, m5);
          };
          switch (M4) {
            case h3:
          ...
          if (!t4) return this.$L;
          var n3 = this.clone(), r4 = w4(t4, e4, true);
      ...
      return O2.prototype = k3, [["$ms", r3], ["$s", i3], ["$m", s3], ["$H", u3], ["$W", a3], ["$M", c3], ["$y", h3], ["$D", d2]].forEach((function(t4) {
        k3[t4[1]] = function(e4) {
          return this.$g(e4, t4[0], t4[1]);
        };
      })), O2.extend = function(t4, e4) {
        return t4.$i || (t4(e4, _3, O2), t4.$i = true), O2;
      }, O2.locale = w4, O2.isDayjs = S2, O2.unix = function(t4) {
        return O2(1e3 * t4);
      }, O2.en = D3[g4], O2.Ls = D3, O2.p = {}, O2;
    }));
  }
});
...
FullCalendarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  contentQueries: function FullCalendarComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      \u0275\u0275contentQuery(dirIndex, _c3, 7)(dirIndex, _c4, 7)(dirIndex, _c5, 7)(dirIndex, _c6, 7)(dirIndex, _c7, 7)(dirIndex, _c8, 7)(dirIndex, _c9, 7)(dirIndex, _c10, 7)(dirIndex, _c11, 7)(dirIndex, _c12, 7)(dirIndex, _c13, 7)(dirIndex, _c14, 7)(dirIndex, _c15, 7)(dirIndex, _c16, 7)(dirIndex, _c17, 7);
    }
    if (rf & 2) {
      let _t;
...
// src/app/pages/app/applications/calendar/calendar.component.ts
var import_dayjs = __toESM(require_dayjs_min());

// src/app/pages/app/applications/calendar/snackbar-event.component.ts
var SnackbarSuccessComponent = class _SnackbarSuccessComponent {
  constructor() {
    this.snackBarRef = inject(MatSnackBarRef);
  }
  static {
    this.\u0275fac = function SnackbarSuccessComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SnackbarSuccessComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SnackbarSuccessComponent, selectors: [["app-snackbar-success"]], decls: 9, vars: 0, consts: [[1, "row", "gx-3", "align-items-center"], [1, "col"], ["matSnackBarLabel", ""], [1, "col-auto"], ["matSnackBarActions", ""], ["matIconButton", "", "matSnackBarAction", "", 3, "click"], [1, "material-icons-outlined"]], template: function SnackbarSuccessComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "p", 2);
        \u0275\u0275text(3, "Booking SMS sent to customer");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(4, "div", 3)(5, "span", 4)(6, "button", 5);
        \u0275\u0275listener("click", function SnackbarSuccessComponent_Template_button_click_6_listener() {
    ...
    }, dependencies: [MatButtonModule, MatIconButton, MatIconModule, MatIcon, MatSnackBarLabel, MatSnackBarActions, MatSnackBarAction], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SnackbarSuccessComponent, [{
    type: Component,
    args: [{ selector: "app-snackbar-success", imports: [MatButtonModule, MatIconModule, MatSnackBarLabel, MatSnackBarActions, MatSnackBarAction], template: `<div class="row gx-3 align-items-center">
        <div class="col">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SnackbarSuccessComponent, { className: "SnackbarSuccessComponent", filePath: "src/app/pages/app/applications/calendar/snackbar-event.component.ts", lineNumber: 22 });
})();

// src/app/pages/app/applications/calendar/createevent.component.ts
var _forTrack0 = ($index, $item) => $item.Name;
var _forTrack1 = ($index, $item) => $item.Timestamp;
function CreateEventModal_div_3_For_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", option_r1, " ");
  }
}
function CreateEventModal_div_3_For_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-chip-option", 16);
    \u0275\u0275element(1, "img", 24);
  ...
  if (rf & 2) {
    const coach_r2 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("alt", \u0275\u0275interpolate1("Profile picture of ", coach_r2.Name))("src", coach_r2.Image, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(coach_r2.Name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(coach_r2.Profession);
  }
}
function CreateEventModal_div_3_For_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-chip-option", 16);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", time_r3.Timestamp, " ");
  }
}
function CreateEventModal_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10)(1, "mat-form-field", 11)(2, "mat-label");
    \u0275\u0275text(3, "Book for");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "input", 12);
    \u0275\u0275elementStart(5, "mat-autocomplete", null, 0);
    \u0275\u0275repeaterCreate(7, CreateEventModal_div_3_For_8_Template, 2, 2, "mat-option", 13, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(9, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "h4", 14);
    \u0275\u0275text(11, "Select Coach");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "mat-chip-listbox", 15);
    \u0275\u0275repeaterCreate(13, CreateEventModal_div_3_For_14_Template, 7, 5, "mat-chip-option", 16, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 17)(16, "div", 18)(17, "h4", 14);
    \u0275\u0275text(18, "Select Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "mat-form-field", 11)(20, "mat-label");
    \u0275\u0275text(21, "Choose a date");
    \u0275\u0275elementEnd();
    \u0275\u0275element(22, "input", 19)(23, "mat-datepicker-toggle", 20)(24, "mat-datepicker", 21, 1);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div", 22)(27, "h4", 14);
    \u0275\u0275text(28, "Select Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "mat-chip-listbox", 23);
    \u0275\u0275repeaterCreate(30, CreateEventModal_div_3_For_31_Template, 2, 1, "mat-chip-option", 16, _forTrack1);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const auto_r4 = \u0275\u0275reference(6);
    const picker_r5 = \u0275\u0275reference(25);
    const ctx_r5 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275property("formControl", ctx_r5.searchControl)("matAutocomplete", auto_r4);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(9, 5, ctx_r5.filteredOptions));
    \u0275\u0275advance(6);
    \u0275\u0275repeater(ctx_r5.coachList);
    \u0275\u0275advance(9);
    \u0275\u0275property("matDatepicker", picker_r5);
    \u0275\u0275advance();
    \u0275\u0275property("for", picker_r5);
    \u0275\u0275advance();
    \u0275\u0275property("dateClass", ctx_r5.dateClass);
    \u0275\u0275advance(6);
    \u0275\u0275repeater(ctx_r5.originaltimeList);
  }
}
function CreateEventModal_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10)(1, "mat-card", 28)(2, "mat-card-content")(3, "div", 29)(4, "div", 8)(5, "mat-icon", 30);
    \u0275\u0275text(6, "check_circle");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 5)(8, "h4", 31);
    \u0275\u0275text(9, "Appointment Confirmed");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(10, "mat-card", 32)(11, "mat-card-content")(12, "div", 33)(13, "div", 8)(14, "div", 34);
    \u0275\u0275element(15, "img", 35);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 5)(17, "h4", 31);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "p", 36);
    \u0275\u0275text(20, "32 year");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(21, "div", 37)(22, "div", 8)(23, "div", 38)(24, "mat-icon", 30);
    \u0275\u0275text(25, "local_hospital");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "div", 5)(27, "h4", 31);
    \u0275\u0275text(28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "p", 36);
    \u0275\u0275text(30);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(31, "div", 37)(32, "div", 39);
    \u0275\u0275text(33, "Date");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(36, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(37, "div", 37)(38, "div", 39);
    \u0275\u0275text(39, "Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "div", 40);
    \u0275\u0275text(41);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(42, "div", 37)(43, "div", 39);
    \u0275\u0275text(44, "Code");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "div", 40);
    \u0275\u0275text(46);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(47, "div", 37)(48, "div", 41);
    \u0275\u0275text(49, "Location");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "div", 42);
    \u0275\u0275text(51);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(52, "div", 43)(53, "div", 44);
    \u0275\u0275element(54, "img", 45);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const ctx_r5 = \u0275\u0275nextContext();
    \u0275\u0275advance(18);
    \u0275\u0275textInterpolate(ctx_r5.appointment.BookedName);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate(ctx_r5.appointment.CoachName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r5.appointment.profession);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(36, 7, ctx_r5.appointment.date, "mediumDate"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r5.appointment.time);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r5.appointment.confirmationCode);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r5.appointment.location);
  }
}
function CreateEventModal_button_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 46);
    \u0275\u0275listener("click", function CreateEventModal_button_7_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r5 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r5.openSnackBar());
    });
...
function CreateEventModal_button_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 47);
    \u0275\u0275listener("click", function CreateEventModal_button_8_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r5 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r5.appointmentBooked());
    });
    \u0275\u0275elementStart(1, "mat-icon", 30);
    \u0275\u0275text(2, "event");
    \u0275\u0275elementEnd();
...
function CreateEventModal_button_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 47);
    \u0275\u0275listener("click", function CreateEventModal_button_9_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r5 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r5.appointmentBooked());
    });
...
var CreateEventModal = class _CreateEventModal {
  constructor() {
    this._snackBar = inject(MatSnackBar);
    this.durationInSeconds = 5;
    this.bookappointment = signal(true, ...ngDevMode ? [{ debugName: "bookappointment" }] : (
    ...
    this.originaltimeList = [{ Timestamp: "9:30 AM" }, { Timestamp: "10:30 AM" }, { Timestamp: "11:30 AM" }, { Timestamp: "12:30 PM" }, { Timestamp: "01:30 PM" }, { Timestamp: "02:30 PM" }, { Timestamp: "04:30 PM" }, { Timestamp: "05:00 PM" }, { Timestamp: "05:30 PM" }, { Timestamp: "06:00 PM" }];
    this.searchControl = new FormControl("");
    this.options = ["John Doe", "Jane Smith", "Michael Johnson", "Emily Davis", "David Wilson", "Sarah Brown", "James Taylor", "Jessica Miller", "Daniel Moore", "Linda Garcia", "Robert Rodriguez", "Susan Martinez"];
    this.appointment = {
      id: "TICKET-2026-589",
  ...
  openSnackBar() {
    this._snackBar.openFromComponent(SnackbarSuccessComponent, {
      duration: this.durationInSeconds * 1e3,
  ...
  static {
    this.\u0275fac = function CreateEventModal_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _CreateEventModal)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CreateEventModal, selectors: [["app-createevent"]], features: [\u0275\u0275ProvidersFeature([provideNativeDateAdapter()])], decls: 13, vars: 5, consts: [["auto", "matAutocomplete"], ["picker", ""], ["mat-dialog-title", ""], [1, "pt-2", "mat-typography"], ["class", "book-appointment", 4, "ngIf"], [1, "col"], ["matButton", "elevated", 3, "click", 4, "ngIf"], ["matButton", "filled", 3, "click", 4, "ngIf"], [1, "col-auto"], ["matButton", "", "mat-dialog-close", "", 1, "theme-red"], [1, "book-appointment"], ["appearance", "outline", 1, "w-100"], ["type", "text", "matInput", "", 3, "formControl", "matAutocomplete"], [3, "value"], [1, "mb-3"], ["aria-label", "Doctors", 1, "mb-3", "doclist"], [1, "px-1"], [1, "row", "gx-3"], [1, "col-12", "col-sm-6", "col-xl-12", "mb-2"], ["matInput", "", 3, "matDatepicker"], ["matIconSuffix", "", 3, "for"], [3, "dateClass"], [1, "col-12", "col-sm-6", "col-xl-12"], ["aria-label", "timeavailable", 1, "mb-3"], ["matChipAvatar", "", 1, "", 3, "src", "alt"], [1, ""], [1, "mb-0"], [1, "text-secondary", "small", "fw-normal"], [1, "bg-light-theme", "text-theme", "mb-3", "mb-lg-4", "theme-green", "shadow-none"], [1, "row", "gx-3", "align-items-center"], [1, "material-icons-outlined"], [1, "mb-1"], [1, "mb-3", "mb-lg-4"], [1, "row", "gx-3", "align-items-center", "mb-3", "mb-lg-4"], [1, "avatar", "avatar-60", "rounded-circle"], ["src", "assets/img/user-2.jpg", "alt", ""], [1, "text-secondary", "small"], [1, "row", "gx-3", "mb-3"], [1, "avatar", "avatar-40", "bg-light-theme", "text-theme", "theme-red", "rounded"], [1, "col", "text-secondary"], [1, "col-auto", "text-end"], [1, "col-3", "text-secondary"], [1, "col", "text-end"], [1, "text-center"], [1, "avatar", "avatar-100", "rounded"], ["src", "assets/img/qr-code.png", "alt", "QR Code"], ["matButton", "elevated", 3, "click"], ["matButton", "filled", 3, "click"]], template: function CreateEventModal_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "h3", 2);
        \u0275\u0275text(1, "Book an Appointment");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(2, "mat-dialog-content", 3);
        \u0275\u0275template(3, CreateEventModal_div_3_Template, 32, 7, "div", 4)(4, CreateEventModal_div_4_Template, 55, 10, "div", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(5, "mat-dialog-actions")(6, "div", 5);
        \u0275\u0275template(7, CreateEventModal_button_7_Template, 4, 0, "button", 6)(8, CreateEventModal_button_8_Template, 4, 0, "button", 7)(9, CreateEventModal_button_9_Template, 4, 0, "button", 7);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", ctx.bookappointment());
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.bookappointment());
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", !ctx.bookappointment());
    ...
    }, dependencies: [CommonModule, NgIf, MatDividerModule, MatAutocompleteModule, MatAutocomplete, MatOption, MatAutocompleteTrigger, MatCardModule, MatCard, MatCardContent, MatFormFieldModule, MatFormField, MatLabel, MatSuffix, MatInputModule, MatInput, MatButtonModule, MatButton, MatIconModule, MatIcon, MatChipsModule, MatChipAvatar, MatChipListbox, MatChipOption, MatDatepickerModule, MatDatepicker, MatDatepickerInput, MatDatepickerToggle, ReactiveFormsModule, DefaultValueAccessor, NgControlStatus, FormControlDirective, MatDialogTitle, MatDialogContent, MatDialogActions, MatDialogClose, AsyncPipe, DatePipe], styles: ["\n\n.doclist[_ngcontent-%COMP%] {\n  --mat-chip-container-height: 44px;\n  --mat-chip-with-avatar-avatar-size: 30px;\n  --mat-chip-with-icon-icon-size: 30px;\n}\n/*# sourceMappingURL=createevent.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CreateEventModal, [{
    type: Component,
    args: [{ selector: "app-createevent", standalone: true, providers: [provideNativeDateAdapter()], imports: [CommonModule, MatDividerModule, MatAutocompleteModule, MatCardModule, MatFormFieldModule, MatInputModule, MatButtonModule, MatIconModule, MatChipsModule, MatDatepickerModule, ReactiveFormsModule, MatDialogTitle, MatDialogContent, MatDialogActions, MatDialogClose, MatButtonModule], template: `
    ...
    `, styles: ["/* angular:styles/component:css;1c05540ab9e4d35a5f92dffa145b7b71cca9389ba0db818617277de8fd1c9b39;C:/Users/msi/Downloads/billing-complete-v8/billing-project/Pi_ProjetFront/src/app/pages/app/applications/calendar/createevent.component.ts */\n.doclist {\n  --mat-chip-container-height: 44px;\n  --mat-chip-with-avatar-avatar-size: 30px;\n  --mat-chip-with-icon-icon-size: 30px;\n}\n/*# sourceMappingURL=createevent.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CreateEventModal, { className: "CreateEventModal", filePath: "src/app/pages/app/applications/calendar/createevent.component.ts", lineNumber: 181 });
})();

// src/app/pages/app/applications/calendar/calendar.component.ts
var _forTrack02 = ($index, $item) => $item.Name;
var _forTrack12 = ($index, $item) => $item.Timestamp;
function CalendarComponent_div_74_For_10_Template(rf, ctx) {
  if (rf & 1) {
...
function CalendarComponent_div_74_For_16_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const coach_r3 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("alt", \u0275\u0275interpolate1("Profile picture of ", coach_r3.Name))("src", coach_r3.Image, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(coach_r3.Name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(coach_r3.Profession);
  }
}
function CalendarComponent_div_74_For_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-chip-option", 35);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", time_r4.Timestamp, " ");
  }
}
function CalendarComponent_div_74_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 29)(1, "h4", 30);
    \u0275\u0275text(2, "Book an appointment");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 31)(4, "mat-label");
    \u0275\u0275text(5, "Book for");
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "input", 32);
    \u0275\u0275elementStart(7, "mat-autocomplete", null, 0);
    \u0275\u0275repeaterCreate(9, CalendarComponent_div_74_For_10_Template, 2, 2, "mat-option", 33, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(11, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "h4", 30);
    \u0275\u0275text(13, "Select Coach");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "mat-chip-listbox", 34);
    \u0275\u0275repeaterCreate(15, CalendarComponent_div_74_For_16_Template, 7, 5, "mat-chip-option", 35, _forTrack02);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 17)(18, "div", 36)(19, "h4", 30);
    \u0275\u0275text(20, "Select Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "mat-form-field", 37)(22, "mat-label");
    \u0275\u0275text(23, "Choose a date");
    \u0275\u0275elementEnd();
    \u0275\u0275element(24, "input", 38)(25, "mat-datepicker-toggle", 39)(26, "mat-datepicker", 40, 1);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 41)(29, "h4", 30);
    \u0275\u0275text(30, "Select Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "mat-chip-listbox", 42);
    \u0275\u0275repeaterCreate(32, CalendarComponent_div_74_For_33_Template, 2, 1, "mat-chip-option", 35, _forTrack12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "button", 43);
    \u0275\u0275listener("click", function CalendarComponent_div_74_Template_button_click_34_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.appointmentBooked());
    });
  ...
  if (rf & 2) {
    ...
    const picker_r7 = \u0275\u0275reference(27);
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275property("formControl", ctx_r4.searchControl)("matAutocomplete", auto_r6);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(11, 5, ctx_r4.filteredOptions));
    \u0275\u0275advance(6);
    \u0275\u0275repeater(ctx_r4.coachList);
    \u0275\u0275advance(9);
    \u0275\u0275property("matDatepicker", picker_r7);
    \u0275\u0275advance();
    \u0275\u0275property("for", picker_r7);
    \u0275\u0275advance();
    \u0275\u0275property("dateClass", ctx_r4.dateClass);
    \u0275\u0275advance(6);
    \u0275\u0275repeater(ctx_r4.originaltimeList);
  }
}
function CalendarComponent_div_75_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 29)(1, "mat-card", 48)(2, "mat-card-content")(3, "div", 4)(4, "div", 18)(5, "mat-icon", 10);
    \u0275\u0275text(6, "check_circle");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 20)(8, "h4", 6);
    \u0275\u0275text(9, "Appointment Confirmed");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(10, "mat-card", 25)(11, "mat-card-content")(12, "div", 49)(13, "div", 50);
    \u0275\u0275element(14, "img", 51);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "h4", 6);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "p", 7);
    \u0275\u0275text(18, "32 year");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(19, "mat-divider", 25);
    \u0275\u0275elementStart(20, "div", 52)(21, "div", 18)(22, "div", 53)(23, "mat-icon", 10);
    \u0275\u0275text(24, "local_hospital");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(25, "div", 20)(26, "h4", 6);
    \u0275\u0275text(27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "p", 7);
    \u0275\u0275text(29);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(30, "div", 52)(31, "div", 54);
    \u0275\u0275text(32, "Date");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(35, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "div", 52)(37, "div", 54);
    \u0275\u0275text(38, "Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "div", 55);
    \u0275\u0275text(40);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(41, "div", 52)(42, "div", 54);
    \u0275\u0275text(43, "Code");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "div", 55);
    \u0275\u0275text(45);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div", 52)(47, "div", 56);
    \u0275\u0275text(48, "Location");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "div", 57);
    \u0275\u0275text(50);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "div", 58)(52, "div", 59);
    \u0275\u0275element(53, "img", 60);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(54, "div", 61)(55, "div", 20)(56, "button", 62);
    \u0275\u0275listener("click", function CalendarComponent_div_75_Template_button_click_56_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.openSnackBar());
    });
    \u0275\u0275elementStart(57, "mat-icon", 10);
    \u0275\u0275text(58, "sms");
    \u0275\u0275elementEnd();
    \u0275\u0275text(59, " Send");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(60, "div", 20)(61, "button", 43);
    \u0275\u0275listener("click", function CalendarComponent_div_75_Template_button_click_61_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.appointmentBooked());
    });
    \u0275\u0275elementStart(62, "mat-icon", 10);
    \u0275\u0275text(63, "event");
    \u0275\u0275elementEnd();
    \u0275\u0275text(64, " Book New");
    \u0275\u0275elementEnd()()()();
  ...
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(16);
    \u0275\u0275textInterpolate(ctx_r4.appointment.BookedName);
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate(ctx_r4.appointment.CoachName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r4.appointment.profession);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(35, 7, ctx_r4.appointment.date, "mediumDate"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r4.appointment.time);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r4.appointment.confirmationCode);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r4.appointment.location);
  }
}
var CalendarComponent = class _CalendarComponent {
  constructor() {
    ...
    this.originaltimeList = [{ Timestamp: "9:30 AM" }, { Timestamp: "10:30 AM" }, { Timestamp: "11:30 AM" }, { Timestamp: "12:30 PM" }, { Timestamp: "01:30 PM" }, { Timestamp: "02:30 PM" }, { Timestamp: "04:30 PM" }, { Timestamp: "05:00 PM" }, { Timestamp: "05:30 PM" }, { Timestamp: "06:00 PM" }];
    this.currentday = (0, import_dayjs.default)().get("date");
    this.thismonth = (0, import_dayjs.default)().format("MM");
    this.thisyear = (0, import_dayjs.default)().format("YYYY");
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CalendarComponent, selectors: [["app-calendar"]], features: [\u0275\u0275ProvidersFeature([provideNativeDateAdapter()])], decls: 76, vars: 3, consts: [["auto", "matAutocomplete"], ["picker", ""], [1, "container-fluid", "fade-in", "mb-3", "mb-lg-4"], [1, "bg-light-theme", "shadow-none", "pt-3", "pb-lg-3", "px-3"], [1, "row", "gx-3", "align-items-center"], [1, "col", "mb-3", "mb-xl-0", "py-1"], [1, "mb-1"], [1, "text-secondary", "small"], [1, "col-auto", "mb-3", "mb-xl-0"], ["matButton", "filled", 3, "click"], [1, "material-icons-outlined"], [1, "container", "fade-in"], [1, "row", "mb-4"], [1, "col-12", "col-md-12", "col-xl"], [1, "row", "gx-3", "gx-lg-4"], [1, "col-6", "col-sm-3", "col-lg-3", "col-xl-3"], [1, "bg-light-theme", "mb-3", "mb-lg-4", "theme-cyan"], [1, "row", "gx-3"], [1, "col-auto"], [1, "avatar", "avatar-40", "text-center", "rounded", "text-white", "bg-theme"], [1, "col"], [1, "bg-light-theme", "mb-3", "mb-lg-4", "theme-orange"], [1, "bg-light-theme", "mb-3", "mb-lg-4", "theme-violet"], [1, "card", "adminuiux-card"], [1, "bg-light-theme", "mb-3", "mb-lg-4", "theme-blue"], [1, "mb-3", "mb-lg-4"], [3, "options"], [1, "col-12", "col-md-12", "col-xl-3"], ["class", "book-appointment", 4, "ngIf"], [1, "book-appointment"], [1, "mb-3"], ["appearance", "outline", 1, "w-100"], ["type", "text", "matInput", "", 3, "formControl", "matAutocomplete"], [3, "value"], ["aria-label", "Doctors", 1, "mat-mdc-chip-set-stacked", "mb-3", "doclist"], [1, "px-1"], [1, "col-12", "col-sm-6", "col-xl-12", "mb-0", "mb-lg-1"], ["appearance", "outline", 1, "w-100", "mb-3"], ["matInput", "", 3, "matDatepicker"], ["matIconSuffix", "", 3, "for"], [3, "dateClass"], [1, "col-12", "col-sm-6", "col-xl-12", "mb-3", "mb-lg-4"], ["aria-label", "timeavailable", 1, "mb-3"], ["matButton", "filled", 1, "w-100", 3, "click"], ["matChipAvatar", "", 1, "", 3, "src", "alt"], [1, ""], [1, "mb-0"], [1, "text-secondary", "small", "fw-normal"], [1, "bg-light-theme", "text-theme", "mb-3", "mb-lg-4", "theme-green", "shadow-none"], [1, "text-center", "mb-3", "mb-lg-4"], [1, "avatar", "avatar-100", "rounded-circle", "mb-3"], ["src", "assets/img/user-2.jpg", "alt", ""], [1, "row", "gx-3", "mb-3"], [1, "avatar", "avatar-40", "bg-light-theme", "text-theme", "theme-red", "rounded"], [1, "col", "text-secondary"], [1, "col-auto", "text-end"], [1, "col-3", "text-secondary"], [1, "col", "text-end"], [1, "text-center"], [1, "avatar", "avatar-100", "rounded"], ["src", "assets/img/qr-code.png", "alt", "QR Code"], [1, "row", "gx-3", "mb-3", "mb-lg-4"], ["matButton", "elevated", 1, "w-100", 3, "click"]], template: function CalendarComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 2)(1, "mat-card", 3)(2, "div", 4)(3, "div", 5)(4, "h3", 6);
        \u0275\u0275text(5, "Calendar");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "p", 7);
        \u0275\u0275text(7, "Manage and create appointments");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275text(11, "edit_calendar");
        \u0275\u0275elementEnd();
        \u0275\u0275text(12, " Book");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(13, "div", 11)(14, "div", 12)(15, "div", 13)(16, "div", 14)(17, "div", 15)(18, "mat-card", 16)(19, "mat-card-content")(20, "div", 17)(21, "div", 18)(22, "div", 19)(23, "mat-icon", 10);
        \u0275\u0275text(24, "event");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(25, "div", 20)(26, "h4", 6);
        \u0275\u0275text(27, "1320");
        ...
        \u0275\u0275text(29, "Booking");
        \u0275\u0275elementEnd()()()()()();
        \u0275\u0275elementStart(30, "div", 15)(31, "mat-card", 21)(32, "mat-card-content")(33, "div", 17)(34, "div", 18)(35, "div", 19)(36, "mat-icon", 10);
        \u0275\u0275text(37, "account_balance");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(38, "div", 20)(39, "h4", 6);
        \u0275\u0275text(40, "20");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(41, "p", 7);
        \u0275\u0275text(42, "Funds");
        \u0275\u0275elementEnd()()()()()();
        \u0275\u0275elementStart(43, "div", 15)(44, "mat-card", 22)(45, "mat-card-content")(46, "div", 17)(47, "div", 18)(48, "div", 19)(49, "mat-icon", 10);
        \u0275\u0275text(50, "group");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(51, "div", 20)(52, "h4", 6);
        \u0275\u0275text(53, "1320");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(54, "p", 7);
        \u0275\u0275text(55, "Clients");
        \u0275\u0275elementEnd()()()()()();
        \u0275\u0275elementStart(56, "div", 15)(57, "div", 23)(58, "mat-card", 24)(59, "mat-card-content")(60, "div", 17)(61, "div", 18)(62, "div", 19)(63, "mat-icon", 10);
        \u0275\u0275text(64, "apartment");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(65, "div", 20)(66, "h4", 6);
        \u0275\u0275text(67, "820");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(68, "p", 7);
        \u0275\u0275text(69, "Partners");
        \u0275\u0275elementEnd()()()()()()()();
        \u0275\u0275elementStart(70, "mat-card", 25)(71, "mat-card-content");
        \u0275\u0275element(72, "full-calendar", 26);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(73, "div", 27);
        \u0275\u0275template(74, CalendarComponent_div_74_Template, 38, 7, "div", 28)(75, CalendarComponent_div_75_Template, 65, 10, "div", 28);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(72);
    ...
    }, dependencies: [CommonModule, NgIf, FullCalendarModule, FullCalendarComponent, MatCardModule, MatCard, MatCardContent, MatDividerModule, MatDivider, MatAutocompleteModule, MatAutocomplete, MatOption, MatAutocompleteTrigger, MatFormFieldModule, MatFormField, MatLabel, MatSuffix, MatInputModule, MatInput, MatButtonModule, MatButton, MatIconModule, MatIcon, MatChipsModule, MatChipAvatar, MatChipListbox, MatChipOption, MatDatepickerModule, MatDatepicker, MatDatepickerInput, MatDatepickerToggle, ReactiveFormsModule, DefaultValueAccessor, NgControlStatus, FormControlDirective, AsyncPipe, DatePipe], styles: ["\n\n.doclist[_ngcontent-%COMP%] {\n  --mat-chip-container-height: 44px;\n  --mat-chip-with-avatar-avatar-size: 30px;\n  --mat-chip-with-icon-icon-size: 30px;\n}\n/*# sourceMappingURL=calendar.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CalendarComponent, [{
    type: Component,
    args: [{ selector: "app-calendar", standalone: true, providers: [provideNativeDateAdapter()], imports: [CommonModule, FullCalendarModule, MatCardModule, MatDividerModule, MatAutocompleteModule, MatFormFieldModule, MatInputModule, MatButtonModule, MatIconModule, MatChipsModule, MatDatepickerModule, ReactiveFormsModule], template: `
    ...
    `, styles: ["/* angular:styles/component:css;1c05540ab9e4d35a5f92dffa145b7b71cca9389ba0db818617277de8fd1c9b39;C:/Users/msi/Downloads/billing-complete-v8/billing-project/Pi_ProjetFront/src/app/pages/app/applications/calendar/calendar.component.ts */\n.doclist {\n  --mat-chip-container-height: 44px;\n  --mat-chip-with-avatar-avatar-size: 30px;\n  --mat-chip-with-icon-icon-size: 30px;\n}\n/*# sourceMappingURL=calendar.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CalendarComponent, { className: "CalendarComponent", filePath: "src/app/pages/app/applications/calendar/calendar.component.ts", lineNumber: 295 });
})();
export {
  CalendarComponent
};
//# sourceMappingURL=calendar.component-OPEEWFBV.js.map
