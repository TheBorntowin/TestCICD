...
// src/app/pages/app/task-manage/all-task.component.ts
...
function AllTaskComponent_For_18_Template(rf, ctx) {
  if (rf & 1) {
...
function AllTaskComponent_Conditional_29_th_57_Template(rf, ctx) {
  if (rf & 1) {
...
function AllTaskComponent_Conditional_29_td_58_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 62)(1, "p", 63);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function AllTaskComponent_Conditional_29_th_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 61);
    \u0275\u0275text(1, "Title");
    \u0275\u0275elementEnd();
...
function AllTaskComponent_Conditional_29_td_61_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 64);
    \u0275\u0275listener("dblclick", function AllTaskComponent_Conditional_29_td_61_Template_td_dblclick_0_listener() {
      const task_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.openEffortLogDialog(task_r6));
    });
    \u0275\u0275elementStart(1, "p")(2, "span", 65);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
...
function AllTaskComponent_Conditional_29_th_63_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 61);
...
function AllTaskComponent_Conditional_29_td_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 62)(1, "div", 67)(2, "div", 25)(3, "div", 68);
    \u0275\u0275element(4, "img", 69);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 34)(6, "p", 70);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("alt", \u0275\u0275interpolate(task_r7.assignedTo))("src", task_r7.assignedToimage, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(task_r7.assignedTo);
  }
}
function AllTaskComponent_Conditional_29_th_66_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 61);
    \u0275\u0275text(1, "Status");
    \u0275\u0275elementEnd();
...
function AllTaskComponent_Conditional_29_td_67_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 62)(1, "span", 71);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "titlecase");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction5(4, _c3, task_r8.status === "in-progress", task_r8.status === "ready to test", task_r8.status === "new", task_r8.status === "resolved", task_r8.status === "completed"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 2, task_r8.status), " ");
  }
}
function AllTaskComponent_Conditional_29_th_69_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 61);
    \u0275\u0275text(1, "Priority");
    \u0275\u0275elementEnd();
...
function AllTaskComponent_Conditional_29_td_70_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 62)(1, "span", 72)(2, "mat-icon", 73);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "titlecase");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction3(7, _c4, task_r9.priority === "High", task_r9.priority === "Medium", task_r9.priority === "Low"));
    \u0275\u0275advance();
    \u0275\u0275classProp("high-priority", task_r9.priority === "High");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", task_r9.priority === "High" ? "warning" : "flag", " ");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 5, task_r9.priority), " ");
  }
}
function AllTaskComponent_Conditional_29_th_72_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 61);
    \u0275\u0275text(1, "Effort");
    \u0275\u0275elementEnd();
...
function AllTaskComponent_Conditional_29_td_73_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 62)(1, "p", 74)(2, "span", 75);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "small", 76);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(task_r10.loggedHours);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" / ", task_r10.assignHours, " hrs");
  }
}
function AllTaskComponent_Conditional_29_th_75_Template(rf, ctx) {
  if (rf & 1) {
...
function AllTaskComponent_Conditional_29_td_76_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 62)(1, "button", 78);
    \u0275\u0275listener("click", function AllTaskComponent_Conditional_29_td_76_Template_button_click_1_listener() {
      const task_r12 = \u0275\u0275restoreView(_r11).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.openEffortLogDialog(task_r12));
    });
    \u0275\u0275elementStart(2, "span", 79);
    \u0275\u0275text(3, " more_time ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "button", 80);
    \u0275\u0275listener("click", function AllTaskComponent_Conditional_29_td_76_Template_button_click_4_listener($event) {
      return $event.stopPropagation();
    });
    \u0275\u0275elementStart(5, "mat-icon", 17);
    \u0275\u0275text(6, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "mat-menu", null, 1)(9, "button", 81);
    \u0275\u0275listener("click", function AllTaskComponent_Conditional_29_td_76_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.createTask());
    });
    \u0275\u0275elementStart(10, "mat-icon", 17);
    \u0275\u0275text(11, "edit");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "span");
    \u0275\u0275text(13, "Edit");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "button", 82)(15, "mat-icon", 17);
    \u0275\u0275text(16, "delete");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const actionsMenu_r13 = \u0275\u0275reference(8);
    \u0275\u0275advance(4);
    \u0275\u0275property("matMenuTriggerFor", actionsMenu_r13);
  }
}
function AllTaskComponent_Conditional_29_tr_77_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 83);
  }
}
function AllTaskComponent_Conditional_29_tr_78_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 84);
  }
}
function AllTaskComponent_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()()()()()();
    \u0275\u0275elementStart(41, "mat-card", 20)(42, "mat-card-content")(43, "div", 24)(44, "div", 28)(45, "h3", 6);
    \u0275\u0275text(46, "My Tasks");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(47, "p", 41);
    \u0275\u0275text(48, "2 Task Added, 4 Task Resolved, 1 Ready to Test");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(49, "div", 42)(50, "mat-form-field", 43)(51, "input", 44, 0);
    \u0275\u0275listener("keyup", function AllTaskComponent_Conditional_29_Template_input_keyup_51_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.applyFilter($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "mat-icon", 45);
    \u0275\u0275text(54, "search");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(55, "table", 46);
    \u0275\u0275elementContainerStart(56, 47);
    \u0275\u0275template(57, AllTaskComponent_Conditional_29_th_57_Template, 2, 0, "th", 48)(58, AllTaskComponent_Conditional_29_td_58_Template, 3, 1, "td", 49);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(59, 50);
    \u0275\u0275template(60, AllTaskComponent_Conditional_29_th_60_Template, 2, 0, "th", 48)(61, AllTaskComponent_Conditional_29_td_61_Template, 6, 1, "td", 51);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(62, 52);
    \u0275\u0275template(63, AllTaskComponent_Conditional_29_th_63_Template, 2, 0, "th", 48)(64, AllTaskComponent_Conditional_29_td_64_Template, 8, 4, "td", 49);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(65, 53);
    \u0275\u0275template(66, AllTaskComponent_Conditional_29_th_66_Template, 2, 0, "th", 48)(67, AllTaskComponent_Conditional_29_td_67_Template, 4, 10, "td", 49);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(68, 54);
    \u0275\u0275template(69, AllTaskComponent_Conditional_29_th_69_Template, 2, 0, "th", 48)(70, AllTaskComponent_Conditional_29_td_70_Template, 6, 11, "td", 49);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(71, 55);
    \u0275\u0275template(72, AllTaskComponent_Conditional_29_th_72_Template, 2, 0, "th", 48)(73, AllTaskComponent_Conditional_29_td_73_Template, 6, 2, "td", 49);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(74, 56);
    \u0275\u0275template(75, AllTaskComponent_Conditional_29_th_75_Template, 2, 0, "th", 57)(76, AllTaskComponent_Conditional_29_td_76_Template, 19, 1, "td", 49);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275template(77, AllTaskComponent_Conditional_29_tr_77_Template, 1, 0, "tr", 58)(78, AllTaskComponent_Conditional_29_tr_78_Template, 1, 0, "tr", 59);
    \u0275\u0275elementEnd();
    \u0275\u0275element(79, "mat-paginator", 60);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
register();
var AllTaskComponent = class _AllTaskComponent {
  constructor() {
    ...
    this.displayedColumns = ["taskId", "title", "assignedTo", "status", "priority", "assignedHours", "actions"];
  }
  ngOnInit() {
  ...
  static {
    this.\u0275fac = function AllTaskComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _AllTaskComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AllTaskComponent, selectors: [["app-all-task"]], viewQuery: function AllTaskComponent_Query(rf, ctx) {
      if (rf & 1) {
    ...
    }, decls: 30, vars: 2, consts: [["input", ""], ["actionsMenu", "matMenu"], [1, "container-fluid", "fade-in", "mb-3", "mb-lg-4"], [1, "bg-light-theme", "shadow-none", "pt-3", "pb-lg-3", "px-3"], [1, "row", "gx-3", "align-items-center"], [1, "col-12", "col-md", "mb-3", "mb-xl-0", "py-1"], [1, "mb-1"], [1, "small"], ["routerLink", "/app/dashboard", 1, "me-2", "text-theme", "style-none"], [1, "material-icons-outlined", "align-middle", "text-sm"], [1, "material-icons-outlined", "align-middle", "text-sm", "me-2"], [1, "col-12", "col-md-4", "col-xl-3", "mb-3", "mb-xl-0"], ["appearance", "outline", 1, "inline-small", "w-100"], ["placeholder", "Select Project", 3, "formControl"], [3, "value"], [1, "col-auto", "order-2", "mb-3", "mb-xl-0"], ["matButton", "", 1, "ms-1", 3, "click"], [1, "material-icons-outlined"], ["matButton", "filled", 1, "ms-1", 3, "click"], [1, "container", "fade-in"], [1, "mb-3", "mb-lg-4"], [1, "pb-0"], [1, "row", "gx-3", "gx-lg-4"], [1, "col-12", "col-lg-12", "col-xl-6"], [1, "row", "gx-3"], [1, "col-auto"], [1, "avatar", "avatar-80", "coverimg", "rounded", "mb-3"], ["alt", "Project Image", 1, "d-none", 3, "src"], [1, "col", "mb-3"], [1, "text-secondary", "mb-2"], [1, "badge", "badge-light", "me-1", 3, "ngClass"], [1, "col-12", "col-md-6", "col-xl-3"], [1, "mb-3"], [1, "row", "gx-3", "mb-3"], [1, "col"], [1, "text-secondary"], ["mode", "determinate", 1, "mb-3", 3, "value"], [1, "mb-3", "d-flex", "align-items-center"], [1, "avatar", "avatar-40", "coverimg", "rounded-circle", "align-middle", "me-2"], ["alt", "Team Image", 1, "d-none", 3, "src"], [1, "align-middle", "d-inline-block", "flex-grow-1"], [1, "text-secondary", "small"], [1, "col-12", "col-lg-5", "col-xl-4", "mb-3"], ["appearance", "outline", 1, "w-100", "inline-small"], ["matInput", "", "placeholder", "E.g., Task, Manager, Status...", 3, "keyup"], ["matSuffix", ""], ["mat-table", "", "matSort", "", 1, "bg-none", "responsive-table", 3, "dataSource"], ["matColumnDef", "taskId"], ["mat-header-cell", "", "mat-sort-header", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "title"], ["mat-cell", "", "class", "hoverview", 3, "dblclick", 4, "matCellDef"], ["matColumnDef", "assignedTo"], ["matColumnDef", "status"], ["matColumnDef", "priority"], ["matColumnDef", "assignedHours"], ["matColumnDef", "actions"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["aria-label", "Select page of tasks", 1, "bg-none", 3, "pageSizeOptions"], ["mat-header-cell", "", "mat-sort-header", ""], ["mat-cell", ""], ["routerLink", "/app/task-details", 1, "fw-bold", "text-theme"], ["mat-cell", "", 1, "hoverview", 3, "dblclick"], [1, "text-truncated", "d-inline-block", "align-middle", 2, "max-width", "200px"], [1, "material-symbols-outlined", "hoverview-icon", "text-sm", "align-middle", "d-inline-block", "text-theme", "ms-1"], [1, "row", "gx-2", "align-items-center", "flex-nowrap"], [1, "avatar", "avatar-20", "rounded-circle", "coverimg"], [1, "", 3, "src", "alt"], [1, "mb-0", "text-truncated"], [1, "badge", 3, "ngClass"], [1, "badge", "badge-light", "text-theme", 3, "ngClass"], [1, "text-sm"], [1, "text-truncated", 2, "max-width", "200px"], [1, "fw-bold"], [1, "fw-bold", "text-secondary"], ["mat-header-cell", ""], ["matIconButton", "", 3, "click"], [1, "material-symbols-outlined"], ["matIconButton", "", "aria-label", "Actions", 3, "click", "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], ["mat-menu-item", ""], ["mat-header-row", ""], ["mat-row", ""]], template: function AllTaskComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(17, AllTaskComponent_For_18_Template, 2, 2, "mat-option", 14, _forTrack0);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(19, "div", 15)(20, "button", 16);
        \u0275\u0275listener("click", function AllTaskComponent_Template_button_click_20_listener() {
        ...
        \u0275\u0275listener("click", function AllTaskComponent_Template_button_click_24_listener() {
        ...
        \u0275\u0275conditionalCreate(29, AllTaskComponent_Conditional_29_Template, 80, 26);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(16);
    ...
    }, dependencies: [CommonModule, NgClass, RouterLink, MatCardModule, MatCard, MatCardContent, MatIconModule, MatIcon, MatMenuModule, MatMenu, MatMenuItem, MatMenuTrigger, MatProgressBarModule, MatProgressBar, MatTableModule, MatTable, MatHeaderCellDef, MatHeaderRowDef, MatColumnDef, MatCellDef, MatRowDef, MatHeaderCell, MatCell, MatHeaderRow, MatRow, MatPaginatorModule, MatPaginator, MatSortModule, MatSort, MatSortHeader, MatButtonModule, MatButton, MatIconButton, MatButtonToggleModule, MatFormFieldModule, MatFormField, MatSuffix, FormsModule, NgControlStatus, ReactiveFormsModule, FormControlDirective, MatListModule, MatInputModule, MatInput, MatSelectModule, MatSelect, MatOption, MatChipsModule, TitleCasePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AllTaskComponent, [{
    type: Component,
    args: [{ selector: "app-all-task", standalone: true, imports: [CommonModule, RouterLink, MatCardModule, MatIconModule, MatMenuModule, MatProgressBarModule, MatTableModule, MatPaginatorModule, MatSortModule, MatButtonModule, MatButtonToggleModule, MatFormFieldModule, FormsModule, ReactiveFormsModule, MatListModule, MatInputModule, MatSelectModule, MatChipsModule], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AllTaskComponent, { className: "AllTaskComponent", filePath: "src/app/pages/app/task-manage/all-task.component.ts", lineNumber: 310 });
})();
export {
  AllTaskComponent
};
//# sourceMappingURL=all-task.component-T5JAYWW2.js.map
