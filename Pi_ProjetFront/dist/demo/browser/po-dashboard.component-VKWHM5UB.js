...
// src/app/pages/app/po/po-dashboard.component.ts
function PoDashboardComponent_th_82_Template(rf, ctx) {
  if (rf & 1) {
...
function PoDashboardComponent_td_83_Template(rf, ctx) {
  if (rf & 1) {
...
function PoDashboardComponent_th_85_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 41);
    \u0275\u0275text(1, "Role");
    \u0275\u0275elementEnd();
...
function PoDashboardComponent_td_86_Template(rf, ctx) {
  if (rf & 1) {
...
function PoDashboardComponent_th_88_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 41);
    \u0275\u0275text(1, "Status");
    \u0275\u0275elementEnd();
...
function PoDashboardComponent_td_89_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 47)(1, "span", 48);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function PoDashboardComponent_th_91_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 41);
    \u0275\u0275text(1, "Joined");
    \u0275\u0275elementEnd();
...
function PoDashboardComponent_td_92_Template(rf, ctx) {
  if (rf & 1) {
...
function PoDashboardComponent_tr_93_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 50);
  }
}
function PoDashboardComponent_tr_94_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 51);
  }
}
function PoDashboardComponent_p_96_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 52);
    \u0275\u0275text(1, "No team members found.");
    \u0275\u0275elementEnd();
  }
}
function PoDashboardComponent_div_106_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("width", ctx_r2.teamMembers.length ? r_r6.count / ctx_r2.teamMembers.length * 100 : 0, "%");
    \u0275\u0275property("ngClass", ctx_r2.getProgressClass(r_r6.role));
  }
}
var PoDashboardComponent = class _PoDashboardComponent {
  constructor() {
  ...
  get activeMembers() {
    return this.teamMembers.filter((u) => u.isActive).length;
  }
  get tutorCount() {
    return this.teamMembers.filter((u) => u.role === "TUTOR").length;
  }
  get studentCount() {
    return this.teamMembers.filter((u) => u.role === "STUDENT").length;
  }
  get roleStats() {
  ...
  ngOnInit() {
    this.userService.getAll().subscribe({
      next: (data) => {
        this.teamMembers = data.filter((u) => ["MANAGER", "EMPLOYEE", "TUTOR", "STUDENT", "VIEWER"].includes(u.role));
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PoDashboardComponent, selectors: [["app-po-dashboard"]], decls: 107, vars: 10, consts: [[1, "container-fluid", "fade-in", "mb-3", "mb-lg-4"], [1, "bg-light-theme", "shadow-none", "pt-3", "pb-lg-3", "px-3"], [1, "row", "gx-3", "align-items-center"], [1, "col", "mb-3", "mb-xl-0", "py-1"], [1, "mb-1"], [1, "small", "opacity-50"], [1, "container", "fade-in"], [1, "row", "gx-3", "gx-lg-4", "mb-3"], [1, "col-12", "col-md-6", "col-lg-3"], [1, "mb-3"], [1, "col-auto"], [1, "avatar", "avatar-50", "bg-light-theme", "text-theme", "rounded", "theme-blue"], [1, "material-icons-outlined"], [1, "col"], [1, "small", "text-secondary", "mb-1"], [1, "avatar", "avatar-50", "bg-light-theme", "text-theme", "rounded", "theme-green"], [1, "avatar", "avatar-50", "bg-light-theme", "text-theme", "rounded", "theme-yellow"], [1, "avatar", "avatar-50", "bg-light-theme", "text-theme", "rounded", "theme-red"], [1, "row", "gx-3", "gx-lg-4"], [1, "col-12", "col-lg-8"], [1, "mb-3", "mb-lg-4"], [1, "w-100"], [1, "col-auto", "mb-3"], [1, "avatar", "avatar-40", "text-theme", "rounded"], [1, "col", "mb-3"], [1, "text-secondary", "small"], ["mat-stroked-button", "", "routerLink", "/app/users"], ["mat-table", "", 1, "bg-none", "mb-3", "responsive-table", 3, "dataSource"], ["matColumnDef", "user"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", "class", "py-2", 4, "matCellDef"], ["matColumnDef", "role"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "status"], ["matColumnDef", "created"], ["mat-cell", "", "class", "small text-secondary", 4, "matCellDef"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["class", "text-secondary small text-center", 4, "ngIf"], [1, "col-12", "col-lg-4"], ["class", "mb-3", 4, "ngFor", "ngForOf"], ["mat-header-cell", ""], ["mat-cell", "", 1, "py-2"], [1, "avatar", "avatar-36", "rounded-circle", "bg-light-theme", "text-theme", "d-flex", "align-items-center", "justify-content-center"], [1, "material-icons-outlined", 2, "font-size", "18px"], [1, "mb-0"], [1, "text-secondary", "small", "mb-0"], ["mat-cell", ""], [1, "badge", "badge-light", "d-inline-block", 3, "ngClass"], ["mat-cell", "", 1, "small", "text-secondary"], ["mat-header-row", ""], ["mat-row", ""], [1, "text-secondary", "small", "text-center"], [1, "d-flex", "justify-content-between", "mb-1"], [1, "progress", 2, "height", "6px", "border-radius", "4px", "background", "#f0f0f0"], [1, "progress-bar", 2, "border-radius", "4px", "transition", "width 0.5s ease", 3, "ngClass"]], template: function PoDashboardComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(74, "Team Overview");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(75, "p", 25);
        \u0275\u0275text(76, "All members in your scope");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(77, "div", 22)(78, "a", 26);
        \u0275\u0275text(79, "Manage Team");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(80, "table", 27);
        \u0275\u0275elementContainerStart(81, 28);
        \u0275\u0275template(82, PoDashboardComponent_th_82_Template, 2, 0, "th", 29)(83, PoDashboardComponent_td_83_Template, 11, 2, "td", 30);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275elementContainerStart(84, 31);
        \u0275\u0275template(85, PoDashboardComponent_th_85_Template, 2, 0, "th", 29)(86, PoDashboardComponent_td_86_Template, 3, 2, "td", 32);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275elementContainerStart(87, 33);
        \u0275\u0275template(88, PoDashboardComponent_th_88_Template, 2, 0, "th", 29)(89, PoDashboardComponent_td_89_Template, 3, 2, "td", 32);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275elementContainerStart(90, 34);
        \u0275\u0275template(91, PoDashboardComponent_th_91_Template, 2, 0, "th", 29)(92, PoDashboardComponent_td_92_Template, 3, 4, "td", 35);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275template(93, PoDashboardComponent_tr_93_Template, 1, 0, "tr", 36)(94, PoDashboardComponent_tr_94_Template, 1, 0, "tr", 37);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(95, "mat-card-content");
        \u0275\u0275template(96, PoDashboardComponent_p_96_Template, 2, 0, "p", 38);
        \u0275\u0275elementEnd()()();
        ...
        \u0275\u0275text(104, "Members per role");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(105, "mat-card-content");
        \u0275\u0275template(106, PoDashboardComponent_div_106_Template, 8, 6, "div", 40);
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate1("Welcome, ", ctx.currentUser == null ? null : ctx.currentUser.fullName, " \u2014 manage your product backlog and team");
        \u0275\u0275advance(15);
        \u0275\u0275textInterpolate(ctx.teamMembers.length);
        \u0275\u0275advance(13);
        \u0275\u0275textInterpolate(ctx.activeMembers);
        \u0275\u0275advance(13);
        \u0275\u0275textInterpolate(ctx.tutorCount);
        \u0275\u0275advance(13);
        \u0275\u0275textInterpolate(ctx.studentCount);
        \u0275\u0275advance(19);
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", ctx.teamMembers.length === 0);
        \u0275\u0275advance(10);
        \u0275\u0275property("ngForOf", ctx.roleStats);
      }
    }, dependencies: [CommonModule, NgClass, NgForOf, NgIf, MatCardModule, MatCard, MatCardContent, MatCardHeader, MatIconModule, MatIcon, MatButtonModule, MatButton, MatTableModule, MatTable, MatHeaderCellDef, MatHeaderRowDef, MatColumnDef, MatCellDef, MatRowDef, MatHeaderCell, MatCell, MatHeaderRow, MatRow, MatChipsModule, RouterModule, RouterLink, DatePipe], styles: ["\n\n.badge[_ngcontent-%COMP%] {\n  padding: 4px 10px;\n  border-radius: 20px;\n  font-size: 12px;\n  font-weight: 500;\n}\n.progress-bar[_ngcontent-%COMP%] {\n  height: 6px;\n}\n/*# sourceMappingURL=po-dashboard.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PoDashboardComponent, [{
    type: Component,
    args: [{ selector: "app-po-dashboard", standalone: true, imports: [CommonModule, MatCardModule, MatIconModule, MatButtonModule, MatTableModule, MatChipsModule, RouterModule], template: `
  ...
  `, styles: ["/* angular:styles/component:css;d9e99e1e1009d4a20169ba00152bff5bb3acc355c8c8582d29f28ecd079b3584;C:/Users/msi/Downloads/billing-complete-v8/billing-project/Pi_ProjetFront/src/app/pages/app/po/po-dashboard.component.ts */\n.badge {\n  padding: 4px 10px;\n  border-radius: 20px;\n  font-size: 12px;\n  font-weight: 500;\n}\n.progress-bar {\n  height: 6px;\n}\n/*# sourceMappingURL=po-dashboard.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PoDashboardComponent, { className: "PoDashboardComponent", filePath: "src/app/pages/app/po/po-dashboard.component.ts", lineNumber: 204 });
})();
export {
  PoDashboardComponent
};
//# sourceMappingURL=po-dashboard.component-VKWHM5UB.js.map
